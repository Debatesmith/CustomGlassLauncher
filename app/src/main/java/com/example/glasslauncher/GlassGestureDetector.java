...
public class GlassGestureDetector {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        Log.d("GlassGestureDetector", "onTouchEvent: " + motionEvent.getAction());
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                Log.d("GlassGestureDetector", "ACTION_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d("GlassGestureDetector", "ACTION_MOVE: firstFingerDistanceX=" + firstFingerDistanceX);
            ...
            case MotionEvent.ACTION_UP:
                Log.d("GlassGestureDetector", "ACTION_UP");
                tapAndHoldCountDownTimer.cancel();
    ...
    private boolean detectOneFingerGesture(double tan) {
        Log.d("GlassGestureDetector", "detectOneFingerGesture: tan=" + tan +
                ", distanceX=" + firstFingerDistanceX +
                ", velocityX=" + firstFingerVelocityX);
        ...
        if (tan > TAN_ANGLE_DEGREES) {
            ...
            if (Math.abs(firstFingerDistanceX) < SWIPE_DISTANCE_THRESHOLD_PX
                ...
                Log.d("GlassGestureDetector", "Distance/velocity below threshold");
                if (isInTapRegion) {
                    return onGestureListener.onGesture(Gesture.TAP);
                }
            } else if (firstFingerDistanceX < 0) {
                Log.d("GlassGestureDetector", "Detecting SWIPE_FORWARD");
                return onGestureListener.onGesture(Gesture.SWIPE_FORWARD);
            } else if (firstFingerDistanceX > 0) {
                Log.d("GlassGestureDetector", "Detecting SWIPE_BACKWARD");
